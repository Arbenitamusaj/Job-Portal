    ...
    return (
        <>
            ...
            <div className='w-full  py-20 flex items-center  justify-center flex-col'>
                <h1 className='text-xl mt-4 uppercase tracking-widest border-b-2 border-b-gray-600 py-2 font-semibold mb-8 md:text-2xl lg:text-4xl'>Enter Your Info</h1>
                <form encType="multipart/form-data" onSubmit={handleSubmit} className="sm:w-1/2 w-full px-4 mx-4  h-full" >
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input name='name' onChange={(e) => setFormikData({ ...formikData, name: e.target.value })} type="text" id='title' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter Name ' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input name='email' value={email} disabled type="email" id='email' className='w-full  py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter Email' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <textarea name='about' onChange={(e) => setFormikData({ ...formikData, about: e.target.value })} type="description" id='description' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter description' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input accept="application/pdf" name='cv' onChange={(e) => setFile(e.target.files[0])} type="file" id='file' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter Email' />
                        {
