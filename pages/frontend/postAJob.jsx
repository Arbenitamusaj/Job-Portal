            ...
            <div className='w-full  py-20 flex items-center  justify-center flex-col'>
                ...
                <form onSubmit={handleSubmit} className="sm:w-1/2 w-full px-4 mx-4  h-full" >
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input onChange={(e) => setFormData({ ...formData, title: e.target.value })} type="text" id='title' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter title of job' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input onChange={(e) => setFormData({ ...formData, salary: e.target.value })} type="number" id='salary' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter Salary for this job' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input onChange={(e) => setFormData({ ...formData, email: e.target.value })} type="email" id='email' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter Email to be Contacted for this job' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input onChange={(e) => setFormData({ ...formData, company: e.target.value })} type="text" id='company' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter Company of job' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <textarea onChange={(e) => setFormData({ ...formData, description: e.target.value })} onResize={"none"} type="text" id='description' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter description of job' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input onChange={(e) => setFormData({ ...formData, job_category: e.target.value })} type="text" id='jobCategory' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter Category of job' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input onChange={(e) => setFormData({ ...formData, job_experience: e.target.value })} type="text" id='jobExperience' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter Experience Required for this job' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input onChange={(e) => setFormData({ ...formData, job_vacancy: e.target.value })} type="number" id='jobva' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter Number  of Vacancies' />
                        {
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <input onChange={(e) => setFormData({ ...formData, job_deadline: e.target.value })} type="date" id='jobva' className='w-full py-2 px-3 mb-2 border border-gray-600 rounded' placeholder='Enter Deadline of job' />
                        {
                            error.job_deadline && <p className="text-sm text-red-500">{error.job_deadline}</p>
                        }
                    </div>
                    <button type="submit" className='w-full py-2 rounded bg-gray-800 text-white font-semibold tracking-widest'>Submit</button>
                </form>
            </div>
            <ToastContainer />
        </>
