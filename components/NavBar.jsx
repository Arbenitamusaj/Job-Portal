...
export default function NavBar() {
    ...
    return (
        <>
            <div className={`w-full ${scrolled ? "bg-indigo-600/70" : "bg-indigo-600"} px-6 h-20 bg-gray-500 text-white flex items-center justify-between fixed top-0 left-0 z-50`}>
